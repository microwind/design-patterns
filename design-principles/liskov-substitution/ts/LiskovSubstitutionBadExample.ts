...
const square1: Shape = new Square(6);
const square2: Shape = new Square(12);
const rectangle1: Shape = new Rectangle(8, 5);
const rectangle2: Shape = new Rectangle(9, 6);
...
/**
jarry@jarrys-MBP ts % ts-node LiskovSubstitutionBadExample.ts 
