...
public class JpaDynamicSaltStrategy extends AbstractDynamicSaltStrategy {
    private final ApiInfoService apiInfoService;
    private final ApiDynamicSaltLogService apiDynamicSaltLogService;
    private final ApiAuthService apiAuthService;

    public JpaDynamicSaltStrategy(SignDomainService signDomainService,
                                  SignConfig signConfig,
                                  DynamicSaltMapper dynamicSaltMapper,
                                  ApiInfoService apiInfoService,
                                  ApiDynamicSaltLogService apiDynamicSaltLogService,
                                  ApiAuthService apiAuthService) {
        super(signDomainService, signConfig, dynamicSaltMapper);
        this.apiInfoService = apiInfoService;
        this.apiDynamicSaltLogService = apiDynamicSaltLogService;
