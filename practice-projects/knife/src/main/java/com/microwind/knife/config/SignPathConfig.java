...
public class SignPathConfig {
    ...
    public Map<String, String> interfaceSaltMap() {
        ...
        saltMap.put("/sign/submit-test", "submit_test_salt"); // 提交接口盐值
        return saltMap;
    }
    ...
    public AppAuthRepository appAuthRepository() {
        // 允许访问的接口和禁止访问的接口
        AppAuth app001Auth = new AppAuth(
                "APP001",
                "app001_secret_abc321",
                List.of("/sign/sign-generate", "/sign/submit-test"),
                List.of()
        );
        Map<String, AppAuth> authMap = new HashMap<>();
