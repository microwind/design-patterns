...
1. [AI时代的系统架构设计概述](#一ai时代的系统架构设计概述)
2. [架构设计的核心原则与思维模型](#二架构设计的核心原则与思维模型)
3. [Web系统架构设计](#三web系统架构设计)
4. [App系统架构设计](#四app系统架构设计)
5. [大数据系统架构设计](#五大数据系统架构设计)
6. [AI时代的架构设计新范式](#六ai时代的架构设计新范式)
7. [开发者的转变与新技能](#七开发者的转变与新技能)
8. [实战案例：视频播放系统架构设计](#八实战案例视频播放系统架构设计)
9. [总结](#九总结)
...
graph TD
    ...
    classDef svc fill:#fff9c4,stroke:#f57f17,stroke-width:2px
...
graph LR
    ...
    style B fill:#FFF2CC,stroke:#FF8C00
    style C fill:#E6F2FF,stroke:#0066CC
    style D fill:#E8F8E8,stroke:#2E8B57
```
...
graph TD
    ...
    classDef biz fill:#fff9c4,stroke:#f57f17,stroke-width:2px
    classDef net fill:#c8e6c9,stroke:#1b5e20,stroke-width:2px
    classDef data fill:#f8bbd0,stroke:#880e4f,stroke-width:2px
    classDef server fill:#d1c4e9,stroke:#311b92,stroke-width:2px
...
graph LR
    ...
    style TV fill:#e1f5fe,stroke:#01579b
    style GW fill:#c8e6c9,stroke:#1b5e20
    style BFF fill:#fff9c4,stroke:#f57f17
    style SVC fill:#f8bbd0,stroke:#880e4f
```
...
graph LR
    ...
    classDef collect fill:#e1f5fe,stroke:#01579b
    classDef store fill:#c8e6c9,stroke:#1b5e20
    classDef process fill:#fff9c4,stroke:#f57f17
    classDef serve fill:#f8bbd0,stroke:#880e4f
...
graph TD
    ...
    style L_IN fill:#e1f5fe,stroke:#01579b
    style L_BATCH fill:#c8e6c9,stroke:#1b5e20
    style L_SPEED fill:#fff9c4,stroke:#f57f17
    style L_SERVE fill:#f8bbd0,stroke:#880e4f
    style K_IN fill:#e1f5fe,stroke:#01579b
    style K_MQ fill:#c8e6c9,stroke:#1b5e20
    style K_STREAM fill:#fff9c4,stroke:#f57f17
    style K_SERVE fill:#f8bbd0,stroke:#880e4f
```
...
graph TD
    ...
    style T2 fill:#FFE6E6,stroke:#CC0000
    style T3 fill:#FFE6E6,stroke:#CC0000
    style T4 fill:#FFE6E6,stroke:#CC0000
    style A1 fill:#E8F8E8,stroke:#2E8B57
    style A2 fill:#E8F8E8,stroke:#2E8B57
    style A3 fill:#E8F8E8,stroke:#2E8B57
    style A4 fill:#E8F8E8,stroke:#2E8B57
```
...
graph LR
    ...
    style B fill:#f3d5ff,stroke:#333
    style C fill:#b6e3a8,stroke:#333
    style D fill:#ffe6cc,stroke:#333
    style E fill:#c8e6c9,stroke:#333
    style F fill:#ffd9b3,stroke:#333
```
...
graph TD
    ...
    style F fill:#185FA5,stroke:#0C447C,color:#ffffff
    style G fill:#993556,stroke:#72243E,color:#ffffff
    style H fill:#1D9E75,stroke:#0F6E56,color:#ffffff
```
...
graph TD
    ...
    classDef access fill:#dcedc8,stroke:#33691e
...
graph LR
    ...
    style F fill:#d1c4e9,stroke:#311b92
...
graph TD
    ...
    classDef hot fill:#ffccbc,stroke:#bf360c
    classDef warm fill:#fff9c4,stroke:#f57f17
    classDef cold fill:#d1c4e9,stroke:#311b92
    classDef cdn fill:#c8e6c9,stroke:#1b5e20
...
graph TD
    ...
    classDef dc1 fill:#c8e6c9,stroke:#1b5e20
    classDef dc2 fill:#fff9c4,stroke:#f57f17
    classDef cdn fill:#e1f5fe,stroke:#01579b
...
graph LR
    ...
    style A fill:#99ccff,stroke:#333
    style B fill:#b6e3a8,stroke:#333
    style C fill:#f3d5ff,stroke:#333
```
